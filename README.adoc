...
[source,shell]
----
# Needs requests (see requirements.txt); any Python 3.x
pip install -r requirements.txt
# Countries/languages list is given in the help below
python recipe_bridge.py --country <country> --language <language> --mealie-url https://<mealie_server>
----
...
[source,shell]
----
usage: recipe_bridge.py [-h] --country {at,ch,fr,lu,au,de,gb,nl,se,be,dk,ie,no,us,ca,es,it,nz} --language {de,fr,en,nl,sv,da,nb,es,it} --mealie-url MEALIE_URL [--mealie-tag MEALIE_TAG] [--additional-deliveries ADDITIONAL_DELIVERIES] [--debug]
                        [--dry-run]
...
options:
  ...
  --mealie-url MEALIE_URL, -u MEALIE_URL
